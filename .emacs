...
; org-mode-modern uses some characters in this font
...
(custom-set-variables
 ...
 '(package-selected-packages
      '(consult corfu doom-modeline doom-themes evil exec-path-from-shell
           fill-column-indicator key-chord lsp-mode magit mood-line olivetti
           org-modern rustic spaceline spacemacs-theme treesit vertico))
...
(evil-define-key 'normal 'global (kbd "<leader>a") '("toggle anotations" . eglot-inlay-hints-mode))
